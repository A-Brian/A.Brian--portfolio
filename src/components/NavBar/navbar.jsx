...
const Navbar = () => {
  ...
  return (
   <nav className='navbar'>
    ...
    <Link activeClass='active' to='intro'   smooth={true}   offset={-100} duration={500}
    className='desktopMenuListItem'>Home</Link>
    <Link activeClass='active' to='skills'  offset={-50} smooth={true}  duration={500} className='desktopMenuListItem'>About</Link>
    <Link  activeClass='active' to='projects'  offset={-50} smooth={true}  duration={500}className='desktopMenuListItem'
     
    >Projects</Link>
    <Link  activeClass='active' to='clients'  offset={-50} duration={500}className='desktopMenuListItem'>Clients</Link>
    </div>
